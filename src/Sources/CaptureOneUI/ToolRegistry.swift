...
public enum ToolRegistry {
    ...
    private static func entry(for toolID: String) -> ToolEntry {
        ...
        case "Overlay":
            return .implemented { context in AnyView(OverlayToolView()) }        case "LiveForStudio":
        ...
        case "Vignetting":
            return .implemented { context in
                AnyView(VignettingToolView(controller: COVignettingToolController(adjustmentController: context.adjustmentController)))
            }
        case "Crop":
...
private struct LevelsInspectorToolView: View {
    ...
    var body: some View {
        POLevelsControl(
            blackPointRGB: $controller.levelsBlackPointRGB,
            whitePointRGB: $controller.levelsWhitePointRGB,
            midtoneRGB: $controller.levelsMidtoneRGB,
            targetBlackRGB: $controller.levelsTargetBlackRGB,
            targetWhiteRGB: $controller.levelsTargetWhiteRGB,
            blackPointR: $controller.levelsBlackPointR,
            whitePointR: $controller.levelsWhitePointR,
            midtoneR: $controller.levelsMidtoneR,
            targetBlackR: $controller.levelsTargetBlackR,
            targetWhiteR: $controller.levelsTargetWhiteR,
            blackPointG: $controller.levelsBlackPointG,
            whitePointG: $controller.levelsWhitePointG,
            midtoneG: $controller.levelsMidtoneG,
            targetBlackG: $controller.levelsTargetBlackG,
            targetWhiteG: $controller.levelsTargetWhiteG,
            blackPointB: $controller.levelsBlackPointB,
            whitePointB: $controller.levelsWhitePointB,
            midtoneB: $controller.levelsMidtoneB,
            targetBlackB: $controller.levelsTargetBlackB,
            targetWhiteB: $controller.levelsTargetWhiteB,
