...
public class ShortcutManager: ObservableObject {
    ...
    public static func createDefaultSet() -> ShortcutSet {
        let shortcuts = [
            ...
            KeyboardShortcut(key: "i", modifiers: [], actionID: "com.captureone.tool.annotate"),
            KeyboardShortcut(key: "b", modifiers: [], actionID: "com.captureone.tool.drawMagicBrush"),
            ...
            KeyboardShortcut(key: "l", modifiers: .command, actionID: "com.captureone.autoAdjust"),
