...
#ifndef APPCORESHARED_SWIFT_H
#define APPCORESHARED_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="AppCoreShared",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13AppCoreShared18B2CIdentityManager")
@interface B2CIdentityManager : NSObject
...
SWIFT_CLASS("_TtC13AppCoreShared10BaseObject")
...
SWIFT_CLASS("_TtC13AppCoreShared23CloudSessionLicenseInfo")
@interface CloudSessionLicenseInfo : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC13AppCoreShared14CollectionBase")
@interface CollectionBase : BaseObject
@end

/// Reconstructed singleton for coordinating folder sync across the app.
SWIFT_CLASS("_TtC13AppCoreShared20FolderCollectionSync")
@interface FolderCollectionSync : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
/// Based on version 16.5.9.7 metadata.
SWIFT_CLASS("_TtC13AppCoreShared9ImageBase")
@interface ImageBase : BaseObject
...
SWIFT_CLASS("_TtC13AppCoreShared11LicenseInfo")
@interface LicenseInfo : NSObject <NSCopying>
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
...
SWIFT_CLASS("_TtC13AppCoreShared7MCImage")
@interface MCImage : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC13AppCoreShared9MCVariant")
@interface MCVariant : NSObject
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
SWIFT_CLASS("_TtC13AppCoreShared12MOCollection")
@interface MOCollection : CollectionBase
@end

SWIFT_CLASS("_TtC13AppCoreShared18MOFolderCollection")
@interface MOFolderCollection : MOCollection
@end
...
SWIFT_CLASS("_TtC13AppCoreShared13ObjectContext")
@interface ObjectContext : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC13AppCoreShared13SKUTierTester")
@interface SKUTierTester : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// Based on version 16.5.9.7 metadata.
SWIFT_CLASS("_TtC13AppCoreShared11SessionBase")
@interface SessionBase : BaseObject
@end

/// Reconstructed Base class for Variant entities in AppCoreShared.
/// Based on version 16.5.9.7 metadata.
SWIFT_CLASS("_TtC13AppCoreShared11VariantBase")
@interface VariantBase : BaseObject
