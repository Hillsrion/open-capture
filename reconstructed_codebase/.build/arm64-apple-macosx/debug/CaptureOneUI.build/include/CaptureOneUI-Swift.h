...
#ifndef CAPTUREONEUI_SWIFT_H
#define CAPTUREONEUI_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="CaptureOneUI",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSImage;
@class NSCoder;
SWIFT_CLASS("_TtC12CaptureOneUI14COUIButtonCell")
@interface COUIButtonCell : NSButtonCell
...
SWIFT_CLASS("_TtC12CaptureOneUI23CullingWindowController")
@interface CullingWindowController : NSWindowController
- (nonnull instancetype)initWithWindow:(NSWindow * _Nullable)window OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder SWIFT_UNAVAILABLE;
- (void)windowDidLoad;
- (void)doneAction:(id _Nonnull)sender;
@end
